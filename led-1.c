...
const unsigned char sbox[16] = {12, 5, 6, 4, 9, 0, 10, 13, 3, 14, 15, 8, 11, 7, 1, 2};
...
int main(int argc, char* argv[])
{
	...
	FILE* csvfile = fopen("led_ciphertexts1.csv", "w");
	if (!csvfile) {
	...
	fclose(csvfile);
	printf("\nGenerated and saved %d (2^17) ciphertext samples in 'led_ciphertexts1.csv'.\n", NUM_SAMPLES);
